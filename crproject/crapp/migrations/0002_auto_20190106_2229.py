# Generated by Django 2.1.4 on 2019-01-06 16:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bedroom', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='crapp.Bedroom')),
                ('hall', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='crapp.Hall')),
            ],
        ),
        migrations.CreateModel(
            name='Kitchen',
        ...
        migrations.AddField(
            model_name='handles',
            name='kitchen',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='crapp.Kitchen'),
        ),
        migrations.AddField(
            model_name='doors',
            name='bedroom',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='crapp.Bedroom'),
        ),
        migrations.AddField(
            model_name='doors',
            name='hall',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='crapp.Hall'),
        ),
        migrations.AddField(
            model_name='doors',
            name='kitchen',
